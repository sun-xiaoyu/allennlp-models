...
@DatasetReader.register("transformer_squad_mod")
class TransformerSquadReaderMod(DatasetReader):
    """
    ...
    def text_to_instance(
        ...
        if token_answer_span is not None:
            ...
            fields['answer_type'] = LabelField(AnswerType.SHORT, skip_indexing=True)
        else:
